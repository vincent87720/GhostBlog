...
sudo find ./docs -type f -name 'style.css?*' -exec rm {} \;
sudo find ./docs -type f -name 'script.js?*' -exec rm {} \;
sudo find ./docs/assets/font -type f -name '*?*' -exec rm {} \;

	
#取代檔案內的奇怪字串
sudo find ./docs -type f -name '*.html' -exec ./replace.pl {} \;
